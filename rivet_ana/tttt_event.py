...
if os.path.exists("input.txt"):
    ...
    # MG Old
    # svcMgr.EventSelector.InputCollections=['/lustre/umt3/user/metsai/analysis/ttWH/samples/MCvalidation/mc16_13TeV.410155.aMcAtNloPythia8EvtGen_MEN30NLO_A14N23LO_ttW.merge.EVNT.e5070_e5984/EVNT.12071733._000001.pool.root.1']
